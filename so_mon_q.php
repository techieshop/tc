...
if ($action == "確定") {
  ...
  printf("</head><body bgcolor=#eeeeee link=#000000 onload=openSBWindow('so_mon_l.php?%s','so_mon_l',340,300);window.close();>",$url1);
  printf("</BODY></HTML>");
}
...
printf("<td align=left height=25><font size=+1><b>月結查詢</b></font></td>");
printf("</tr></table>");
...
printf("<th>&nbsp;</th>");
printf("<th colspan=4 align=left height=25><b>請輸入想要查詢月結的日期</b></th>");
printf("</tr><tbody>");
printf("<tr><td>&nbsp;</td></tr>");
printf("<tr>");
