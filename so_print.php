...
<table border=0 cellspacing=0 cellpadding=0 style='border-collapse:collapse;
 ...
 <tr>
  ...
  <p class=MsoNormal align=center style='text-align:center'><b><span
  style='font-size:13.5pt'>發 </span></b><b><span lang=EN-US style='font-size:
  13.5pt;font-family:"Times New Roman";mso-ascii-font-family:新細明體'>&nbsp;&nbsp;</span></b><b><span
  style='font-size:13.5pt'>貨 </span></b><b><span lang=EN-US style='font-size:
  13.5pt;font-family:"Times New Roman";mso-ascii-font-family:新細明體'>&nbsp;&nbsp;</span></b><b><span
  ...
  <p class=MsoNormal align=right style='text-align:right'><b><span lang=EN-US
  style='font-size:13.5pt'><?php echo $oid ?></span></b></p>
  </td>
...
<?php
  ...
  while ($row = mysql_fetch_array($result)) {
    $amount=round($row["unit_price"] * $row["weight"] * 10 + 0.000000001) / 10;
    $total+=$amount;
    $mod_no++;
?>
 <tr style='height:24.1pt'>
  ...
  <p class=MsoNormal align=right style='text-align:right'><b><span lang=EN-US><?php printf("%7.2f",$row["unit_price"]) ?></span></b></p>
  </td>
  <td width=100 style='width:74.85pt;padding:0cm 1.4pt 0cm 1.4pt;height:24.1pt'>
  <p class=MsoNormal align=right style='text-align:right'><b><span lang=EN-US><?php echo ins_comma($amount) ?></span></b></p>
  </td>
...
?>
 ...
 <tr>
  ...
  11.25pt'><b><span lang=EN-US><?php echo ins_comma($total) ?></span></b></p>
  </td>
