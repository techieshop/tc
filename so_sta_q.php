...
if ($action == "確定") {
  ...
  printf("</head><body bgcolor=#eeeeee link=#000000 onload=openSBWindow('so_sta_l.php?%s','so_sta_l',340,300);window.close();>",$url1);
  printf("</BODY></HTML>");
}
...
printf("<td align=left height=25><font size=+1><b>銷售統計查詢</b></font></td>");
printf("</tr></table>");
...
printf("<th>&nbsp;</th>");
printf("<th colspan=4 align=left height=25><b>請輸入想要查詢銷售統計的日期</b></th>");
printf("</tr><tbody>");
printf("<tr><td>&nbsp;</td></tr>");
printf("<tr>");
