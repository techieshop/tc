...
while ($myrow = mysql_fetch_array($result)) {
    ...
    printf("<td align=left><a href=javascript:openPrintWindow('so_sta.php?custno=%s&date_fr=$date_fr&date_to=$date_to','so_sta',790,450);>%s</a></td>",$myrow["customer_id"],$myrow["customer_name"]);
    printf("</tr>");
}
